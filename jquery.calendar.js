 ...
 * extensible, and easily localizable graphical calendar  
 * interface as a jQuery plugin.
 *
 * @author Sam Sehnert, Digital Fusion 2011
 */
	...
	var _private = {
		...
		parse : {
			...
			icalendar : function( ics ){
				...
				console.log( 'Got ICS '+lines.length+' Line(s): ', lines );
				console.log( 'Parsed: ', calendars );
